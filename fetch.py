#!/usr/bin/env python3
"""
Recuperation des codes promo ASOS depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/asos.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/asos.com"
STORE_NAME = "ASOS"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour ASOS depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-asos)"
    }
    try:
